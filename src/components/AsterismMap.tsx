...
const AsterismMap = ({ asterism }: any) => {

  const geometry = asterism.geometry;
  const coordinates = geometry.coordinates;
  
    // Find the bounding box of the asterism's coordinates with padding
    ...
    // Calculate scaling factors to fit the asterism within the viewBox
    ...
    const asterismPaths = coordinates.map((segment, index) => {
